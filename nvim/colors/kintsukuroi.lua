...
vim.g.terminal_color_8 = colors.gery
...
statusline_groups = vim.tbl_extend('error', statusline_groups, {
    ...
    StatuslineGitBranch = { fg = colors.blue, bg = colors.transparent_black, italic = true },
...
local groups = vim.tbl_extend('error', statusline_groups, {
    ...
    Special = { fg = colors.rose, italic = true },
    ...
    Substitute = { fg = colors.pink, bg = colors.transparent_pink, italic = true },
    ...
    ['@module.builtin'] = { fg = colors.orange, italic = true },
    ['@label'] = { fg = colors.cyan },

    -- Literals
    ['@string'] = { fg = colors.yellow },
    ['@string.documentation'] = { fg = colors.yellow, italic = true },
    ...
    ['@type.qualifier'] = { fg = colors.magenta, italic = true },
    ['@attribute'] = { fg = colors.cyan },
    ['@attribute.builtin'] = { fg = colors.cyan, italic = true },
    ...
    ['@keyword.coroutine'] = { fg = colors.magenta, italic = true },
    ...
    ['@keyword.type'] = { fg = colors.magenta, italic = true },
    ['@keyword.modifier'] = { fg = colors.magenta, italic = true },
    ['@keyword.repeat'] = { fg = colors.magenta, italic = true },
    ...
    ['@keyword.include'] = { fg = colors.magenta, italic = true },
    ['@keyword.function.ruby'] = { fg = colors.magenta, italic = true },
    ...
    ['@markup.link.url'] = { fg = colors.yellow, italic = true, underline = true },
    ...
    -- Tags (HTML, JSX, etc.)
    ['@tag'] = { fg = colors.cyan },
    ['@tag.builtin'] = { fg = colors.cyan, italic = true },
    ...
    ['@lsp.type.keyword'] = { fg = colors.magenta, italic = true },
    ['@lsp.type.macro'] = { fg = colors.cyan },
    ['@lsp.type.method'] = { fg = colors.green },
    ['@lsp.type.modifier'] = { fg = colors.magenta, italic = true },
    ['@lsp.type.namespace'] = { fg = colors.orange },
    ['@lsp.type.number'] = { fg = colors.blue },
    ...
    ['@lsp.typemod.variable.readonly'] = { fg = colors.blue },
    ['@lsp.typemod.keyword.async'] = { fg = colors.magenta, italic = true },
