  ...
  config = function()
    local conf = {
      ...
      spec = {
        ...
        { '<leader>tt', desc = '[T]oggle Floating [T]erminal', icon = { icon = ' ', color = 'green' } },
        { 's', group = 'Flash' },
        { 'g', group = 'Goto' },
      },
